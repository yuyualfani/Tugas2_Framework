						...
						<div class="table-responsive">
							<table class="table table-hover">
								<thead>
									...
									<a href="<?php echo site_url('pegawai/create');?>" type="button" class="btn btn-info">Create</a>
								</thead>
								<tbody>
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/update/').$key->id ?>" type="button" class="btn btn-info">Update</a>
											<a type="button"   class="btn btn-danger" onclick="deletechecked(<?php echo  $key->id ?>)">Delete</a>
...
<script>
    ...
    {
    	var $idku = $id;
    	var $link = "<?php echo site_url('pegawai/delete/'); ?>"
